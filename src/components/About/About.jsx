...
import Phrygia from "/static/phrygia.jpg"
...
const AboutBg = styled.div`
  ...
  background-image: url(${profileImageRoot}/aboutBg.jpeg);
      ...
      <section className="about_content">
        <article className="me">
          ...
          <dl>
            ...
            <dd>
              <b>Email.</b>{" "}
              <a href="mailto:dmsgp62@gmail.com">dmsgp62@gmail.com</a> <br />
              <b>Github. </b>
              <button
                onClick={() =>
                  window.open("https://github.com/phrygia", "_blank")
                }
              >
        ...
        <article className="tit">
          ...
          <ul>
            ...
            <li>
              <i>최근에는</i> JS언어를 기반으로 한 프레임워크, 라이브러리를
              공부하고 있습니다.
            </li>
            <li>
        ...
        <article className="days">
          <p>
            안녕하세요, 아름다운 인터페이스 UI와 동적 애니메이션을 구현하는 것을
            좋아합니다.
            <br />
            시맨틱 웹 태그를 기반으로 한 웹 최적화를 좋아하고, SCSS와
            JAVASCRIP를 활용한 애니메이션을 좋아합니다.
          </p>
          <p>
            컴포넌트를 활용한 재사용성에 관심을 두고 있으며 클린 코드를
            지양합니다-* <br />
            항상 사용자 입장을 고려하고 편의성을 제공하려 노력하며, 이에 대해서
            개발자 및 디자이너들과의 토크도 좋아합니다. 커뮤니케이션을
            좋아하지만 제 의견을 말하는 것보다는 경청하는 것을 좋아합니다. ✨
          </p>
          <p>
            사용자뿐만 아니라 클라이언트도 200% 만족하는 서비스를 개발하는 것을
            목표로 하고 있습니다.
          </p>
        </article>
        <article className="stack">
          ...
          <ul>
            ...
            <li>
              · React 라이브러리를 사용할 수 있으며, 열심히 공부하고 있습니다 😄
              (+ Next.js)
            </li>
            ...
            <li>
              · 다양한 웹 솔루션 사용에 능숙합니다 (카페24, 그누보드, 영카트,
              워드프레스 등)
            </li>
          </ul>
        </article>
      ...
      <ul>
        ...
        <article className="education">
          ...
          <ul>
            ...
            <li>
              <span>2017.02 ~ 2017.07 </span> UI.UX 퍼블리싱 국비지원 교육 이수
              (종로이젠컴퓨터)
            </li>
