...
<small class="from">이미지 출처 : <a href="https://ko.wikipedia.org/wiki/%EC%8A%A4%ED%83%9D">위키백과</a></small>
...
console.log(a);  // 1
{% endhighlight %}
<br><img src="/assets/post/scope.jpg" style="max-width: 600px;" />
...
<hr>
<small class="from">참고 : 코어 자바스크립트(정재남), <a href="https://developer.mozilla.org/ko/" target="_blank">MDN</a></small>
